...
<form method="post" action="/ui/edit" class="additional-info">
    <div class="container">
        <h1>Edit your page</h1>
        <p>Please fill in this form to update base information</p>
        <hr>
        ...
        <input name="secondName" type="text" placeholder="Enter your second name" class="form-control" id="secondName"
               required>
        <br/>
        <button id="button" type="submit" class="registerbtn">Update</button>
    </div>
</form>
</body>
</html>